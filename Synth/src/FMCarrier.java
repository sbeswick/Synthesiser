 ...
 *
 */
public class FMCarrier extends UGen
{
	/**
	...
	public Waveform  carrier_wave;	//probably unused
  ...
  private float prevFreq;
	 ...
	 */
	public FMCarrier(float frequencyInHertz, float amplitude, Waveform waveform)
	{
		this(Frequency.ofHertz(frequencyInHertz), amplitude, waveform);
	}
	
	public FMCarrier(float frequencyInHertz, float amplitude, Waveform waveform, UGen modulator)
	{
		this(Frequency.ofHertz(frequencyInHertz), amplitude, waveform);
	}
	 ...
	 */
	public FMCarrier(float frequencyInHertz, float amplitude)
	{
	...
	public FMCarrier(Frequency frequency, float amplitude)
	{
	...
	public FMCarrier(Frequency freq, float amp, Waveform waveform)
	{
		super();
	...
	{		
		...
		//seb edit
		//sample = carrier(t + modulator(t))
		//System.out.println(mod_sample);
		//System.out.println(tmpStep);
		float sample = outAmp * carrier_wave.value(tmpStep) + offset.getLastValue();
